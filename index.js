const {
  ...
  const ownerNumber = ['263717777643']
...
const sessdata = config.SESSION_ID.replace("Techsync-MD~", '');
...
*ᴛᴇᴄʜsʏɴᴄ-ᴍᴅ*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/nrex3k.png` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263717777643', '263771912275', '263782627612');
