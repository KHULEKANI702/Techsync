...
const REPO_OWNER = 'mvelase-ofc';
const REPO_NAME = 'Techsync';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *Techsync Plugins:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*Techsync Plugins:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://raw.githubusercontent.com/mvelase-ofc/Techsync/main/assets/Techsync Menu.png` }, // Replace with your image URL
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: 'Techsync~MD 𝖯𝗅𝗎𝗀𝗂𝗇𝗌',
                    serverMessageId: 143
                }
            }
        };
